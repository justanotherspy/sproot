...
func newValidateCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long:  "validate loads a sproot.yaml and reports any missing or invalid fields. Defaults to the config_path from ~/.sproot/config.yaml, or sproot.yaml in the current directory. A missing sproot.yaml is a warning by default; use --strict to treat it as an error.",
